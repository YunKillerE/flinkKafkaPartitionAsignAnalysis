 ...
 */
@Internal
public class KafkaFetcherY<T> extends AbstractFetcher<T, TopicPartition> {

	private static final Logger LOG = LoggerFactory.getLogger(KafkaFetcherY.class);
	...
	private final KafkaConsumerThreadY consumerThread;
	...
	public KafkaFetcherY(
		...
		this.consumerThread = new KafkaConsumerThreadY(
			LOG,
			handover,
			kafkaProperties,
