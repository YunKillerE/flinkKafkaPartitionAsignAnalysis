 ...
 */
@PublicEvolving
public class FlinkKafkaConsumerY<T> extends FlinkKafkaConsumerBaseY<T> {
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(String topic, DeserializationSchema<T> valueDeserializer, Properties props) {
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(String topic, KafkaDeserializationSchema<T> deserializer, Properties props) {
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(List<String> topics, DeserializationSchema<T> deserializer, Properties props) {
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(List<String> topics, KafkaDeserializationSchema<T> deserializer, Properties props) {
	 ...
	 * {@link FlinkKafkaConsumerY#KEY_PARTITION_DISCOVERY_INTERVAL_MILLIS} in the properties), topics
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(Pattern subscriptionPattern, DeserializationSchema<T> valueDeserializer, Properties props) {
	 ...
	 * @param props
	 */
	public FlinkKafkaConsumerY(Pattern subscriptionPattern, KafkaDeserializationSchema<T> deserializer, Properties props) {
		this(null, subscriptionPattern, deserializer, props);
	}

	private FlinkKafkaConsumerY(
		List<String> topics,
	...
	@Override
	public FlinkKafkaConsumerBaseY<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
