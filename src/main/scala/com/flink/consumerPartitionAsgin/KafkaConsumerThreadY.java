 ...
 */
@Internal
public class KafkaConsumerThreadY extends Thread {
	...
	private String KafkaConsumerThreadYname;

	public KafkaConsumerThreadY(
			Logger log,
			Handover handover,
		...
		super(threadName);
		setDaemon(true);
		KafkaConsumerThreadYname = threadName;
		...
		//log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init  : " + );
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init  ============================================ ");
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init threadName : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init handover : " + handover.toString() + "    threadName  : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init kafkaProperties : " + kafkaProperties + "    threadName  : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init unassignedPartitionsQueue : " +
				unassignedPartitionsQueue + "    threadName  : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init pollTimeout: " + pollTimeout + "    threadName  : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init running : " + running + "    threadName  : " + threadName);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init  ============================================ ");
	}
	...
	public void run() {
		...
		// this is the means to talk to FlinkKafkaConsumerY's main thread
		...
		try {
			...
			//log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY init  : " + );
			log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run consumer.assignment() : " +
					consumer.assignment() + "    threadName  : " + KafkaConsumerThreadYname);
...
/*				log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running commitInProgress : " + commitInProgress);
				log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running hasAssignedPartitions : " + hasAssignedPartitions);*/

				try {
					if (hasAssignedPartitions) {
						newPartitions = unassignedPartitionsQueue.pollBatch();
/*						try {
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running hasAssignedPartitions newPartitions toString : " +
									newPartitions);
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running hasAssignedPartitions newPartitions toArray : " +
									newPartitions);
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running hasAssignedPartitions newPartitions newPartitions : " +
									newPartitions);
						}catch (Exception e){
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running hasAssignedPartitions newPartitions newPartitions : " +
									newPartitions);
...
/*						try {
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running else toString : " +
									newPartitions.toArray().toString());
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running else toArray : " +
									newPartitions.toArray());
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running else newPartitions : " +
									newPartitions);
						}catch (Exception e){
							log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running else newPartitions : " +
									newPartitions);
					...
					if (newPartitions != null) {
						log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY run running else newPartitions : " +
								newPartitions + "    threadName  : " + KafkaConsumerThreadYname);
	...
	void reassignPartitions(List<KafkaTopicPartitionState<TopicPartition>> newPartitions) throws Exception {
		...
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY reassignPartitions : " +
				hasAssignedPartitions + "    threadName  : " + KafkaConsumerThreadYname);
		log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY reassignmentStarted : " +
				reassignmentStarted + "    threadName  : " + KafkaConsumerThreadYname);
		...
		try {
			...
			log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY oldPartitionAssignmentsToPosition : " +
				oldPartitionAssignmentsToPosition + "    threadName  : " + KafkaConsumerThreadYname);
			...
			log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY newPartitionAssignments : " +
					newPartitionAssignments + "    threadName  : " + KafkaConsumerThreadYname);
			...
			log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY consumerTmp.assignment : " +
					consumerTmp.assignment() + "    threadName  : " + KafkaConsumerThreadYname);
			...
			synchronized (consumerReassignmentLock) {
				...
				log.error("FlinkKafkaConsumerBase KafkaConsumerThreadY reassignPartitions catch unassignedPartitionsQueue : " +
						unassignedPartitionsQueue + "    threadName  : " + KafkaConsumerThreadYname);
