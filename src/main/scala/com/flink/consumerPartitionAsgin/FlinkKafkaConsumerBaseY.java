 ...
 */
@Internal
public abstract class FlinkKafkaConsumerBaseY<T> extends RichParallelSourceFunction<T> implements
        CheckpointListener,
	...
	protected static final Logger LOG = LoggerFactory.getLogger(FlinkKafkaConsumerBaseY.class);
	 ...
	 * The value of this can only be determined in {@link FlinkKafkaConsumerBaseY#open(Configuration)} since it depends
	 ...
	 */
	public FlinkKafkaConsumerBaseY(
		List<String> topics,
		...
		LOG.error("FlinkKafkaConsumerBase init begin ========================================= ");
		LOG.error("FlinkKafkaConsumerBase init topicsDescriptor : " + topicsDescriptor.toString());
		LOG.error("FlinkKafkaConsumerBase init deserializer : " + deserializer);
		LOG.error("FlinkKafkaConsumerBase init discoveryIntervalMillis : " + discoveryIntervalMillis);
		LOG.error("FlinkKafkaConsumerBase init useMetrics : " + useMetrics);
		LOG.error("FlinkKafkaConsumerBase init begin ========================================= ");
		//LOG.error("FlinkKafkaConsumerBase init  : " + );
	 ...
	 *
	 * <p>When a subtask of a FlinkKafkaConsumerY source reads multiple Kafka partitions,
	 ...
	 */
	public FlinkKafkaConsumerBaseY<T> assignTimestampsAndWatermarks(AssignerWithPunctuatedWatermarks<T> assigner) {
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> assignTimestampsAndWatermarks(AssignerWithPeriodicWatermarks<T> assigner) {
		checkNotNull(assigner);
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> setCommitOffsetsOnCheckpoints(boolean commitOnCheckpoints) {
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> setStartFromEarliest() {
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> setStartFromLatest() {
	...
	protected FlinkKafkaConsumerBaseY<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> setStartFromGroupOffsets() {
	 ...
	 * {@link FlinkKafkaConsumerBaseY#setStartFromGroupOffsets()}) for that particular partition.
	 *
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> setStartFromSpecificOffsets(Map<KafkaTopicPartition, Long> specificStartupOffsets) {
	 ...
	 * @return The consumer object, to allow function chaining.
	 */
	public FlinkKafkaConsumerBaseY<T> disableFilterRestoredPartitionsWithSubscribedTopics() {
	...
	public void open(Configuration configuration) throws Exception {
		...
		//LOG.error("FlinkKafkaConsumerBase init  : " + );
		LOG.error("FlinkKafkaConsumerBase open init  start =============================================");
		LOG.error("FlinkKafkaConsumerBase open init offsetCommitModeb  : " + offsetCommitMode.name());
		LOG.error("FlinkKafkaConsumerBase init subscribedPartitionsToStartOffsets : " +
			subscribedPartitionsToStartOffsets.keySet());

		for (int i = 0; i < allPartitions.size(); i++) {
			LOG.error("allPartitions for : " + allPartitions.get(i).toString());
		}
		LOG.error("FlinkKafkaConsumerBase init allPartitions : " + allPartitions);

		LOG.error("FlinkKafkaConsumerBase open init  end =============================================");
		...
		if (restoredState != null) {
			...
			//LOG.error("FlinkKafkaConsumerBase init  : " + );
			LOG.error("FlinkKafkaConsumerBase open ifelse init subscribedPartitionsToStartOffsets  : " +
				subscribedPartitionsToStartOffsets.keySet());
		}
	}
	...
	public void run(SourceContext<T> sourceContext) throws Exception {
		...
		//LOG.error("FlinkKafkaConsumerBase run init  : " + );
		LOG.error("FlinkKafkaConsumerBase run init start =================================================== ");
		LOG.error("FlinkKafkaConsumerBase run init subtaskIndex : " + subtaskIndex);
		LOG.error("FlinkKafkaConsumerBase run init kafkaFetcher  : " + kafkaFetcher);
		LOG.error("FlinkKafkaConsumerBase run init running : " + running);
		LOG.error("FlinkKafkaConsumerBase run init subscribedPartitionsToStartOffsets : " +
			subscribedPartitionsToStartOffsets.keySet());
		LOG.error("FlinkKafkaConsumerBase run init periodicWatermarkAssigner : " + periodicWatermarkAssigner);
		LOG.error("FlinkKafkaConsumerBase run init punctuatedWatermarkAssigner : " + punctuatedWatermarkAssigner);
		LOG.error("FlinkKafkaConsumerBase run init offsetCommitMode : " + offsetCommitMode);
		LOG.error("FlinkKafkaConsumerBase run init KAFKA_CONSUMER_METRICS_GROUP : " + KAFKA_CONSUMER_METRICS_GROUP);
		LOG.error("FlinkKafkaConsumerBase run init useMetrics : " + useMetrics);
		LOG.error("FlinkKafkaConsumerBase run init running : " + running);
		LOG.error("FlinkKafkaConsumerBase run init discoveryIntervalMillis : " + discoveryIntervalMillis);
		LOG.error("FlinkKafkaConsumerBase run init end  =================================================== ");
	...
	public final void initializeState(FunctionInitializationContext context) throws Exception {
		...
		if (context.isRestored() && !restoredFromOldState) {
			...
			LOG.info("Setting restore state in the FlinkKafkaConsumerY: {}", restoredState);
		} else {
			LOG.info("No restore state for FlinkKafkaConsumerY.");
		}
	}
